    ...
    rsx! {
        main { class: "page",
            style { "
                ...
                .flow-grid {{ display: grid; grid-template-columns: minmax(0, 1fr) .42fr minmax(0, 1fr) .42fr minmax(0, 1fr); grid-template-areas: '. . solar . .' '. . route1 . .' 'grid route2 hub route3 home' '. . route4 . .' '. . battery . .'; align-items: center; gap: .35rem; margin-top: 1rem; text-align: center; }}
