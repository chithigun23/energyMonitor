    ...
    rsx! {
        main { class: "page",
            style { "
                ...
                .flow-node {{ position: absolute; z-index: 2; width: 23%; box-sizing: border-box; }} .flow-solar {{ top: 0; right: 0; border-color: #d79a00; }} .flow-home {{ top: 0; left: 0; border-color: #3478c6; }} .flow-grid-node {{ bottom: 0; left: 0; }} .flow-grid-out {{ border-color: #1e8e5a; }} .flow-grid-in {{ border-color: #c4543a; }} .flow-battery {{ right: 0; bottom: 0; border-color: #8067c7; }} .flow-line {{ position: absolute; z-index: 1; height: 5px; width: 29%; border-radius: 999px; transform-origin: left center; }} .flow-base {{ background: #c9d8e8; }} .flow-line:not(.flow-base) {{ opacity: .28; background: repeating-linear-gradient(90deg, currentColor 0 5px, transparent 5px 17px); }} .flow-active {{ opacity: 1 !important; animation: flow-dash 1.25s linear infinite; }} .flow-fast {{ animation-duration: .55s; }} .solar-base, .solar-flow {{ left: 77%; top: 27%; transform: rotate(155deg); }} .home-base, .home-flow {{ left: 49%; top: 50%; transform: rotate(-155deg); }} .grid-base {{ left: 23%; top: 73%; transform: rotate(-25deg); }} .grid-import-flow {{ left: 23%; top: 73%; transform: rotate(-25deg); }} .grid-export-flow {{ left: 49%; top: 50%; transform: rotate(155deg); }} .battery-base {{ left: 51%; top: 50%; transform: rotate(25deg); }} .battery-charge-flow {{ left: 51%; top: 50%; transform: rotate(25deg); }} .battery-discharge-flow {{ left: 77%; top: 73%; transform: rotate(-155deg); }} .solar-flow {{ color: #e6ae18; }} .home-flow {{ color: #3478c6; }} .grid-import-flow {{ color: #c4543a; }} .grid-export-flow {{ color: #1e8e5a; }} .battery-charge-flow, .battery-discharge-flow {{ color: #8067c7; }} @keyframes flow-dash {{ to {{ background-position: 51px 0; }} }} .hub {{ position: absolute; z-index: 3; left: 50%; top: 50%; transform: translate(-50%, -50%); width: 3.5rem; height: 3.5rem; border-radius: 50%; display: grid; place-items: center; background: #dce9f7; color: #375879; font-size: 1.5rem; box-shadow: 0 0 0 6px rgba(124, 161, 199, .18), 0 8px 18px rgba(55, 88, 121, .18); }}
